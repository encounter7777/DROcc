...
model = dict(
    type='DenseFusionOccPredictor_drocc_depth_only',
    ...
    backbone=dict(type='mmdet.ResNet',
                  ...
                  init_cfg=dict(type='Pretrained',
                                checkpoint='./weights/resnet50-0676ba61.pth'),
                  style='pytorch'),
    neck=dict(type='mmdet.FPN',
              in_channels=[256, 512, 1024, 2048],
              out_channels=256,
              num_outs=4),
    backbone_3d=dict(type='MinkResNet', in_channels=3, depth=34,depth_only = True),
    bbox_head=dict(
        type='ImVoxelOccHead_drocc',
        volume_h=[20, 10, 5],
        volume_w=[20, 10, 5],
        volume_z=[8, 4, 2],
...
visualizer = dict(type='EmbodiedScanBaseVisualizer', vis_backends=[dict(type='LocalVisBackend')], save_dir='temp_vis')