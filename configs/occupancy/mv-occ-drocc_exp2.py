...
model = dict(
    type='DenseFusionOccPredictor_drocc',
    ...
    bbox_head=dict(
        ...
        use_semantic=True,
        window_size=[[20,20,8], [10, 10, 4], [5, 5, 2]],
    ),
...
visualizer = dict(type='EmbodiedScanBaseVisualizer', vis_backends=[dict(type='LocalVisBackend')], save_dir='temp_vis/drocc_dir')